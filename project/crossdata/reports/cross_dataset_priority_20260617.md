...
Last updated: 2026-06-17 10:45 KST
...
| 5 | DSA+SEA AdaBN+Con | Conformer + DSA+SEA+AdaBN+Con | completed | 71.35% / k=0.427 (n=54) | 68.46% / k=0.369 (n=52) | 69.91% |
| 4 | DANN | CSPNet + DSA+SEA+DANN | pending | n=0 | n=0 |  |

## Queue Status

- Queue stopped at CSPNet + DSA+SEA+DANN exit=1.
