...
| ea_snapshot_adabn_x4_cspnet | EA + CSPNet + Snapshot(x4 T0=75) + AdaBN | 70.06 | 72.94 | 71.50 | 52 | 54 |
| ea_snapshot_adabn_x3_cspnet | EA + CSPNet + Snapshot(x3 T0=100) + AdaBN | 70.25 | 72.59 | 71.42 | 52 | 54 |
...
| ea_adabn_eegnet | EA + EEGNet + AdaBN | 69.89 | 71.62 | 70.75 | 52 | 54 |
| ea_tent_eegnet | EA + EEGNet + TENT | 69.39 | 71.69 | 70.54 | 52 | 54 |
...
| CSPNet + DSA+SEA+AdaBN (sfreq100) | 72.41 | 0.448 | 69.90 | 0.398 | 71.15 |
...
| CSPNet + DSA+SEA+TENT (sfreq100) | 72.22 | 0.444 | 68.54 | 0.371 | 70.38 |
...
| EA+CSPNet (sfreq100) | 59.24 | 0.185 | 61.42 | 0.229 | 60.33 |

## In Progress (2026-06-17)

| Experiment | GPU | Cho2017 (partial) | Lee2019 (partial) | Status |
|---|---|---|---|---|
| EA + Conformer + Snapshot(×6 T0=50) | GPU 2 | 67.72% (39/52) | not started | ~20h remaining |
| EA + CSPNet + StyleAug (p=0.5) | GPU 1 | **68.30%** (52/52 done) | 72.26% (48/54) | ~1h remaining |

> Watcher at `/tmp/forgit_final_watcher.sh` will auto-update `loso/results/` on completion.
